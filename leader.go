...
func (r *controllerImpl) startLeader(shutdown <-chan struct{}) {
...
func (r *controllerImpl) tryLeader(expiry time.Duration) bool {
...
func (r *controllerImpl) startLeadership(stop <-chan struct{}) {
	go r.distributeKeys(stop)
	go r.startMonitoringWorkers(stop)
}

func (r *controllerImpl) startMonitoringWorkers(stop <-chan struct{}) {
...
func (r *controllerImpl) monitorWorkers() {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second)
	defer cancel()
...
func (r *controllerImpl) findDeadWorkers(ctx context.Context, workers []string) ([]string, error) {
...
func (r *controllerImpl) cleanWorkerKeys(worker string) error {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second)
	defer cancel()
...
func (r *controllerImpl) distributeKeys(stop <-chan struct{}) {
...
func (r *controllerImpl) processGlobalQueue() {
...
func (r *controllerImpl) findWorkerForKey(key string) (string, error) {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second)
	defer cancel()

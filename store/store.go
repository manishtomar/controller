...
type Workers interface {
	...
	RemoveWorker(ctx context.Context, worker string) error

	SetWorkerTimeout(ctx context.Context, timeout time.Duration) error

	ListInactiveWorkers(ctx context.Context) ([]string, error)
